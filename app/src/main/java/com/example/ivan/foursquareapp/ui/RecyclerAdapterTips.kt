...
import com.example.ivan.foursquareapp.models.Tip
import kotlinx.android.synthetic.main.item_tip.view.*


class RecyclerAdapterTips(private val mTipsList: List<Tip>) : RecyclerView.Adapter<RecyclerAdapterTips.ViewHolder>() {
